...
public class ExpressionMath {
	...
	/**
	 * Due to the nature of floating point number representations, Java incorrectly evaluates
	 * certain "round" values of trig functions and a small error is introduced. This look-up
	 * table corrects that behaviour.
	 */
    ...
    public static double doOperation(Token operator, double num) throws ExpressionException {
        ...
        // TODO add try/catch for number errors or if answer is infinity.
